        ...
        <table class="table table-bordered">
            <tr class="d-flex">
                ...
                <th class="col-3" id="th_width">Doctor</th>               
                <th class="table-dark  right">Edit</th>  
            </tr>   
            <br>
            <tr>
            ...
            <tr>
             <td><form action="." method="post" id="remove_doctor_form">
                    ...
                    <input type="hidden" name="doctor_id"
                           value="<?php  echo $current_doctor->getId(); ?>">
                    <input class="btn btn-danger btn-sm" type="submit" value="Remove Doctor">
                </form></td>                    
            </tr>            
            ...
            <tr>
                ...
                <td><form action="." method="post"
                    ...
                    <input class="btn btn-danger btn-sm" type="submit" value="Reset">
                    </form></td>
